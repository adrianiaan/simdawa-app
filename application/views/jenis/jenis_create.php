                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="nama_jenis" name="nama_jenis" required placeholder="Nama Jenis Beasiswa" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="keterangan" class="col-md-2">Keterangan</label>
                                <div class="col-md-10">
                                    <input type="text" id="keterangan" name="keterangan" required placeholder="Keterangan" class="form-control">
                                </div>
                            </div>
                            <button type="submit" name="create" class="btn btn-sm btn-info float-right">Simpan</button>
                            <a href="<?= base_url('jenis'); ?>" class="btn btn-sm btn-danger float-right mr-2">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
